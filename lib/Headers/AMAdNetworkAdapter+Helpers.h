...
@interface AMAdNetworkAdapter (Helpers)
...
/**
 * Subclasses call to get various configs to use, from the AMDelegate or
 * config from server.
 */
...
/**
 * Subclasses call to message the AMDelegate with various selectors.
 */
